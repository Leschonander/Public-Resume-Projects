...
api_key <-"KMeXlplWxx8px6DDb21tCxB8a"
api_secret <- "MUg2ntYWqnjFoVgHqvZ2O9fzzKjPYblT9HcGnNXm2PKTrl2ttI"
access_token<-"828366980805754880-LaxZN6SRJSChsyLThs8hoxOh8XeBE1O"
access_secret <- "a5feJTBW4WKkWBDGN39R3Pvt9uiBVU7amdU5wbqgdMbhG"
...
#Used. Then just pluged variance for the formula for SD. 
```{r}
var(analysis)
```
#To get Variance
